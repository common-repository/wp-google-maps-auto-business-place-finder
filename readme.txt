...
== Description ==
 [youtube https://www.youtube.com/watch?v=MNYlIUj7Dk4]

With this plugin, you can show the map with any kind of place, e.g. hotels, restaurants, airports, art galleries etc.
...
2. Upload the wp folder to your '/wp-content/plugins' folder
...
3. Click on Browse and select your "wp-google-maps-auto-business-place-finder.zip" file.
